...
await tester.pumpAndSettle();
 ...
 testWidgets('date bar shows Present/Absent toggles', (tester) async {
   ...
   group('AttendanceSummaryCards', () {
     ...
     testWidgets('ERROR shows error text and retry button', (tester) async {
       await tester.pumpWidget(MaterialApp(
           home: Scaffold(
         body: AttendanceSummaryCards(
           overall: null,
   ...
   group('AttendanceCalendar Today button', () {
testWidgets('Today action exists and navigates to current month',
         (tester) async {
     ...
     testWidgets('Today sets displayed month to current when navigated away',
         (tester) async {
       final today = DateTime.now();
       final calendarData = <CalendarAttendance>[];
       String? selectedDate;
       await tester.pumpWidget(MaterialApp(
           home: Scaffold(
         body: SingleChildScrollView(
